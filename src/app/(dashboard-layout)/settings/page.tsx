...
export default function SettingsPage() {
    ...
    const canEdit = user?.role?.includes('super_admin') || user?.permissions?.includes('settings.edit');
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <button
                                            key={item.id}
                                            onClick={() => canEdit && setTheme(item.id)}
                                ...
                                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <select
                                        disabled={!canEdit}
                                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900 dark:text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                ...
                                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${canEdit ? 'bg-blue-600 cursor-pointer' : 'bg-gray-400 cursor-not-allowed'}`}>
